    ...
    >
        ...
        <v-card>
            ...
            <v-card-text>
                <p>
                    Política de Privacidade
                    A sua privacidade é importante para nós. É política do bannercotação respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site bannercotação, e outros sites que possuímos e operamos.
                    ...
                    Além de outras informações, a bannercotação pode coletar e armazenar seu IP, sempre que você acessar nosso sistema, com o propósito de nos ajudar a evitar fraudes.
                    ...
                    Política de Cookies bannercotação
                    O que são cookies?
                    ...
                    Este site usa o Google Analytics, que é uma das soluções de análise mais difundidas e confiáveisda Web, para nos ajudar a entender como você usa o site e como podemos melhorar sua experiência. Esses cookies podem rastrear itens como quanto tempo você gasta no site e as páginas visitadas, para que possamos continuar produzindo conteúdo atraente.
                    ...
                    O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o bannercotação oferece no site e com caráter enunciativo, mas não limitativo:

                    A) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;
                    B) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do bannercotação, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.
                    Mais informações
